...
public class IntegrationChangeHistoryController {
	...
	public IntegrationChangeHistoryController(IIntegrationChangeHistoryService integrationChangeHistoryService) {
		this.integrationChangeHistoryService = integrationChangeHistoryService;
	}

	@PostMapping(value = "/", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    @ApiImplicitParams({@ApiImplicitParam})
	@ApiOperation(value = "添加积分变化历史记录", notes = "添加积分变化历史记录", response = void.class)
