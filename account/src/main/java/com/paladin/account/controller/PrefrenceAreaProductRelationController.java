...
//    @ApiImplicitParams({@ApiImplicitParam})
	...
	public RespOk findAccount(@RequestBody PrefrenceAreaProductRelation prefrenceAreaProductRelation) {
		PrefrenceAreaProductRelation result =
				prefrenceAreaProductRelationService.getById(prefrenceAreaProductRelation);
	...
	public RespOk findAccountList(@RequestBody PrefrenceAreaProductRelation prefrenceAreaProductRelation) {
		List<PrefrenceAreaProductRelation> prefrenceAreaProductRelationList =
				prefrenceAreaProductRelationService.list(new QueryWrapper<>(prefrenceAreaProductRelation));
