...
//    @ApiImplicitParams({@ApiImplicitParam})
    ...
    public RespOk findAccount(@RequestBody MemberProductCategoryRelation memberProductCategoryRelation) {
        MemberProductCategoryRelation result = memberProductCategoryRelationService.getById(memberProductCategoryRelation);
    ...
    public RespOk findAccountList(@RequestBody MemberProductCategoryRelation memberProductCategoryRelation) {
        List<MemberProductCategoryRelation> memberProductCategoryRelationList = memberProductCategoryRelationService.list(new QueryWrapper<>(memberProductCategoryRelation));
