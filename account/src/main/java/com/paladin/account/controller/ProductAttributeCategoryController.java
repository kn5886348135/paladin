...
public class ProductAttributeCategoryController {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(ProductAttributeCategoryController.class);
...
//    @ApiImplicitParams({@ApiImplicitParam})
    ...
    public RespOk findAccountList(@RequestBody ProductAttributeCategory productAttributeCategory) {
        List<ProductAttributeCategory> productAttributeCategoryList = productAttributeCategoryService.list(new QueryWrapper<>(productAttributeCategory));
